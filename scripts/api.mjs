...
import { PlayerFilterConfiguration, SpellBook, SpellListManager } from './apps/_module.mjs';
...
import { Cantrips, Macros, Migrations, RuleSet, Loadouts, SpellManager, UserDataSetup, WizardBook } from './managers/_module.mjs';
...
export function createAPI() {
  const api = {
    apps: { PlayerFilterConfiguration, SpellBook, SpellListManager },
    dialogs: { CompendiumSelection, SpellComparison, DetailsCustomization, LoadoutSelector, SpellNotes, SpellBookSettings },
    utils: {
      data: DataUtils,
      managers: { Cantrips, Macros, Migrations, RuleSet, Loadouts, SpellManager, UserDataSetup, WizardBook },
      state: State,
      ui: UIUtils,
