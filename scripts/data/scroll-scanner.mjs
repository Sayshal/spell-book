 ...
 * Provides functionality to detect spell scrolls, extract learnable spells,
 * and handle the spell learning process for wizard characters.
 */
export class ScrollScanner {
  /**
   * Scan actor inventory for spell scrolls and extract learnable spells.
   * Only processes scrolls for wizard characters and filters spells by
   * the actor's maximum learnable spell level.
   *
   ...
   * Validates the spell, checks level eligibility, and formats the data
   * for display in the scroll scanner interface.
   *
   ...
   * Handles the complete spell learning workflow including cost calculation,
   * user confirmation, spell copying, and scroll consumption.
   *
   ...
   * @param {WizardSpellbookManager} wizardManager - The wizard manager instance
   ...
   * Presents a confirmation dialog with learning costs, time requirements,
   * and scroll consumption settings for user review.
   *
