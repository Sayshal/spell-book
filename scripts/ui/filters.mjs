...
export class Filters {
  ...
  _checkSpellVisibility(filters, spell) {
    ...
    if ((filters.minRange || filters.maxRange) && spell.rangeUnits) {
      ...
      const convertedRange = this.convertRangeToStandardUnit(spell.rangeUnits, rangeValue);
   ...
   * @private
   */
  getCastingTimeOptions(filterState) {
   ...
   */
  getOptionsForFilter(filterId, filterState) {
    ...
    switch (filterId) {
      ...
      case 'school':
        ...
        break;
      case 'castingTime':
        const uniqueTypes = this.getCastingTimeOptions(filterState);
   ...
   */
  convertRangeToStandardUnit(units, value) {
