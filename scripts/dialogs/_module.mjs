 ...
 *
 * This module provides centralized access to all dialog application classes used
 * throughout the Spell Book module. These dialogs handle various configuration,
 * settings, and user interaction workflows for spell management.
 *
 * @module Dialogs
 * @author Tyler
 */
